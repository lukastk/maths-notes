...
We have a contact matrix $C_{ij}$, which gives the number of reported contacts of age-group *i* with age-group , satisfying
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5MTUzNjkwOCwtMTUwMjgyOTc4XX0=
-->